#line 1 "C:/Users/arcar/OneDrive/Área de Trabalho/RGB Controller FINAL/MLK_RGB_Controller.c"
#line 8 "C:/Users/arcar/OneDrive/Área de Trabalho/RGB Controller FINAL/MLK_RGB_Controller.c"
...
const unsigned int pwm_frec=200;
const unsigned long cristal=Clock_kHz();

const float pwm_reg=65536.0 - 5.5 -(cristal*1000.0/(8.0*100.0*pwm_frec));
...
void Interrpcion() iv 0x0004 ics ICS_AUTO
 ...
 TMR0 = 0x06;
 T0IF_bit = 0x00;
#line 73 "C:/Users/arcar/OneDrive/Área de Trabalho/RGB Controller FINAL/MLK_RGB_Controller.c"
 }
 ...
 if(Button(&PORTA,5,1,0)&&fbt5==1){
 fbt5=0;
 fbt5p=1;
 }

 if(Button(&PORTA,5,1,0)){
 timer5=0;
 }
